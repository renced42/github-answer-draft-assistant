...
public final class SelfTest {
    public static void main(String[] args){
        ...
        check(review.contains("[IDE ÍRD AZ ELLENŐRZÖTT VÉGLEGES VÁLASZT]")&&review.contains("official-source VAGY expert-confirmed")&&review.contains("documented VAGY documentation-gap")&&review.contains("approved-knowledge"),"review issue sablon");
