...
final class GroqClient {
    ...
    String generate(String prompt){
        Map<String,Object> request=new LinkedHashMap<>();request.put("model",config.groqModel());request.put("messages",List.of(Map.of("role","user","content",prompt)));request.put("temperature",0.15);request.put("max_completion_tokens",1200);request.put("stream",false);request.put("reasoning_effort","low");
