...
- Az `approved-knowledge` címke hozzáadása egyben azt jelenti, hogy az issue ellenőrzött végleges válasza és forrásai átadhatók a kiválasztott Groq vagy OpenAI szolgáltatásnak. Titkot, személyes adatot vagy erre nem engedélyezett belső NAV-információt tilos jóváhagyni.
- A Groq-, OpenAI-, SMTP-, GitHub- és tudástár-tokeneket kizárólag GitHub Environment secretként tárold, workflow-fájlba soha ne írd bele.
